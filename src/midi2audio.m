...
%      current choices are:
%          'noenvelope_saw','noenvelope_square', 'noenvelope_sine',
%           'foursegmentenvelopes_sine','KarplusStrong'
%      default:'foursegmentenvelopes_sine'
%
...
for i=1:size(Notes,1)
  ...
  yt = notesynth(f, dur, Fs,amp, synthtype);
